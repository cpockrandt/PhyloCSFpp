...
DIFF_MLE=$(awk -F$'\t' '($1 != $8 || $2 != $9 || $3 != $10 || $4 != $11 || ($5-$12)^2 > 0.00001 || ($6-$13)^2 > 0.00001 || ($7-$14)^2 > 0.00000001)' <(paste example/small/chr22.50alignments.maf.scores example/small/chr22.50alignments.maf.PhyloCSF.mle.scores))
echo -e "${DIFF_MLE}"
