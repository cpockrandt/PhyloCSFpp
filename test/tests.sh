...
echo "FIXED mode"
$PhyloCSFpp score-msa --threads $THREADS --strategy fixed --comp-phylo 1 --comp-anc 1 $species 100vertebrates example/small/chr22.50alignments.maf # no randomization
...
echo "MLE mode"
$PhyloCSFpp score-msa --threads $THREADS --strategy mle --comp-phylo 1 --comp-anc 1 100vertebrates example/small/chr22.50alignments.maf
...
echo "OMEGA mode"
$PhyloCSFpp score-msa --threads $THREADS --strategy omega --comp-phylo 1 --comp-anc 0 100vertebrates example/small/chr22.50alignments.maf
