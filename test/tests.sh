...
echo "FIXED mode"
$PhyloCSFpp scores --threads $THREADS --strategy fixed --comp-phylo 1 --comp-anc 1 --comp-bls 1 $species 100vertebrates example/small/chr22.50alignments.maf
...
DIFF_MLE=$(diff example/small/chr22.50alignments.maf.scores example/small/PhyloCSFpp-results/chr22.50alignments.mle.scores)
echo -e "${DIFF_MLE}"
