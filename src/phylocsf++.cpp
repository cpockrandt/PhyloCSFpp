...
int main(int argc, char **argv)
{
    ...
    args.add_subprogram("region", "Computes PhyloCSF scores, ancestral sequence composition sores and branch length scores for entire alignments from MAF and FASTA files. Outputs them in BED format.");
